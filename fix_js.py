    ...
    container.innerHTML = 
        <div class="premium-gallery scroll-reveal">
            <div class="zoom-image-container" id="zoom-container">
                <img src="" alt="" class="zoom-image" id="zoom-img">
                <button class="premium-wishlist " onclick="toggleWishlist(, this)">
                    <i class="fa-heart "></i>
                </button>
                
            </div>
            <div class="premium-thumbnails">
                <div class="premium-thumb active"><img src="" alt="Thumb 1"></div>
                <div class="premium-thumb" style="filter: brightness(0.8) hue-rotate(20deg);"><img src="" alt="Thumb 2"></div>
                <div class="premium-thumb" style="filter: grayscale(0.5);"><img src="" alt="Thumb 3"></div>
            </div>
        </div>

        <div class="premium-details scroll-reveal">
            <div class="premium-breadcrumbs">Home / Shop /  / <span></span></div>
            ...
            <div class="premium-meta">
                ...
                <span class="premium-category-tag"><i class="fas fa-tag"></i> </span>
            </div>

            <div class="premium-price">{product.price.toFixed(2)}</div>
            
            <p class="premium-excerpt"></p>
